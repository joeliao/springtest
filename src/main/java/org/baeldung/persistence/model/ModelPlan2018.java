...
@Table(name="model_plan2018")



public class ModelPlan2018 {
	@Override
	public String toString() {
		return "ModelPlan2018 [id=" + id + ", province=" + province + ", city=" + city + ", colledgeCode="
				...
				+ ", collegeType=" + collegeType + ", note=" + note + "]";
	}
